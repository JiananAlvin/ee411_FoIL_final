...
class RFF:
    ...
    def __init__(self, input_dim: int, n_features: int, n_classes: int, sigma: float = 5.0):
    ...
    def train(self, X_train: np.ndarray, Y_train: np.ndarray, training_parameters: Dict[str, float] = None):
